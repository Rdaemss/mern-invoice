...
const userSchema = new Schema ({
    ...
    username: {
        ...
        validate: {
            ...
            message: "username must be alphanumeric, without special charachters. Hyphens and underscores allowed"
        }
    },
    ...
    phoneNumber: {
        ...
        validate:[
            validator.isMobilePhone, "Your mobile phone number must begin with a '+', followed by your country code then actual number eg +254123456789"
        ]
    },
    address: String,
    city: String,
